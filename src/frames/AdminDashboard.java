    ...
    private void deleteEmployee() {
        ...
        if (option == 0) {
            try {
                ...
                cmbEAItemName.setSelectedIndex(-1);
    ...
    private void updateEmployee() {
        ...
        if (option == 0) {
            ...
            if (!txtSelectedEmployeeUsername.getText().equals("")
                ...
                if  (!(txtSelectedEmployeeNIC.getText().length() >= 9)) {
                    JOptionPane.showMessageDialog(this, "Invalid NIC!", "Invalid Data", JOptionPane.WARNING_MESSAGE);
                    ...
                    try {
                        DB.DB.putData("UPDATE employee SET position ='" + txtSelectedEmployeePosition.getText() + "', nic ='" + txtSelectedEmployeeNIC.getText() + "', assign_it= '" + cmbEAItemName.getSelectedItem() + "' where id ='" + txtSelectedEmployeeId.getText() + "' ");
                        DB.DB.putData("UPDATE payroll SET payment ='" + "10000" + "' where id ='" + txtSelectedEmployeeId.getText() + "' ");
                        ...
                        cmbEAItemName.getSelectedIndex();
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    String reportSource = "C:\\Program Files\\MTN Inv. Reports\\reports\\viewEmployeeReport.jrxml";
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    String reportSource = "C:\\Program Files\\MTN Inv. Reports\\reports\\viewSelectedEmployeeReport.jrxml";
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    String reportSource = "C:\\Program Files\\MTN Inv. Reports\\reports\\viewSelectedEmployeePaymentBill.jrxml";
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    String reportSource = "C:\\Program Files\\MTN Inv. Reports\\reports\\viewSupplierReport.jrxml";
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    String reportSource = "C:\\Program Files\\MTN Inv. Reports\\reports\\viewSelectedSupplierReport.jrxml";
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    String reportSource = "C:\\Program Files\\MTN Inv. Reports\\reports\\viewSelectedPOBill.jrxml";
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    String reportSource = "C:\\Program Files\\MTN Inv. Reports\\reports\\viewSelectedGRNBill.jrxml";
    ...
    private void addToStock() {
        try {
            ...
            if (stockAvailability.next()) {
                ...
                if (option == 0) {
                    if (!txtGRNItemLowStock.getText().equals("")) {
                        ...
                        if ("Checked".equals(txtGRNStatus.getText())) {
                            ...
                            int selling_price = Integer.parseInt("4000");
    ...
    private void addReOrdersToStock() {
        try {
            ...
            if (!(stockAvailability.next())) {
                ...
                int option = JOptionPane.showConfirmDialog(this, "Do you want to Add this Item to Stock?", "", JOptionPane.YES_NO_OPTION);
                if (option == 0) {
                    if (!txtGRNItemLowStock1.getText().equals("")) {
...
//
                                ...
                                if (stockCountofSelectedItem.next()) {
                                    ...
                                    DB.DB.putData("UPDATE stock SET item_price ='" + txtGRNItemPrice1.getText() + "',selling_price = '" + "400" + "', profit = '" + selectedGRNItemProfitPerSingleItem + "', stock_count ='" + newStockCount + "' WHERE id = '" + stockId + "' ");
    ...
    private void searchStock() {
        switch (cmbSortStock.getSelectedIndex()) {
            ...
            case 4:
                ...
                DefaultTableModel dtm = (DefaultTableModel) tblStock.getModel();
                ResultSet rs = DB.DB.getData("SELECT * FROM stock WHERE stock_status = 'Available' AND (stock_count > low_stock) AND assign_to like '" + txtSearchStock.getText() + "%' order by assign_to ");
                dtm.setRowCount(0);
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    String reportSource = "C:\\Program Files\\MTN Inv. Reports\\reports\\viewStockReport.jrxml";
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    String reportSource = "C:\\Program Files\\MTN Inv. Reports\\reports\\viewBarcodeReport.jrxml";
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    String reportSource = "C:\\Program Files\\MTN Inv. Reports\\reports\\viewLowStockReport.jrxml";
            ...
            public void run() {
                try {
                    ...
                    if (rs.next()) {
                        ...
                        String reportSource = "C:\\Program Files\\MTN Inv. Reports\\reports\\viewTodaySalesReport.jrxml";
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        if (rs1.next()) {
                            ...
                            String reportSource = "C:\\Program Files\\MTN Inv. Reports\\reports\\viewSalesReport.jrxml";
    ...
    private void initComponents() {
        ...
        cmbEAItemName = new javax.swing.JComboBox<>();
        ...
        pnlTop.setBackground(new java.awt.Color(0, 51, 255));
        ...
        maximizeView.setBackground(new java.awt.Color(0, 51, 255));
        ...
        title.setText("Stanbic Bank Inventory");
        ...
        lblAdminUsername.setBackground(new java.awt.Color(255, 255, 255));
        lblAdminUsername.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        lblAdminUsername.setForeground(new java.awt.Color(0, 51, 255));
        ...
        pnlTopLayout.setHorizontalGroup(
            ...
            .addGroup(pnlTopLayout.createSequentialGroup()
                ...
                .addComponent(lblAdminUsername, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        pnlHomeLayout.setVerticalGroup(
            ...
            .addGroup(pnlHomeLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pnlIndicatorHome, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        pnlStockLayout.setVerticalGroup(
            ...
            .addGroup(pnlStockLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pnlIndicatorStock, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        pnlEmployeeLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlEmployeeLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pnlIndicatorEmployee, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        pnlSupplierLayout.setVerticalGroup(
            ...
            .addGroup(pnlSupplierLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(pnlSupplierLayout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(pnlIndicatorSupplier, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        ...
        pnlSettingsLayout.setVerticalGroup(
            ...
            .addGroup(pnlSettingsLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pnlIndicatorSettings, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jLabel111.setText("Stanbic Inventory");
        ...
        watermark.setText("Dev ROB © stanbic INV.");
        ...
        pnlSidebarLayout.setHorizontalGroup(
            ...
            .addGroup(pnlSidebarLayout.createSequentialGroup()
                .addComponent(pnlEmployee, javax.swing.GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(pnlSidebarLayout.createSequentialGroup()
                .addComponent(pnlSettings, javax.swing.GroupLayout.DEFAULT_SIZE, 42, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        pnlLogout.setBackground(new java.awt.Color(0, 51, 255));
        ...
        pnlLogoutLayout.setHorizontalGroup(
            ...
            .addComponent(lblLogout, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
        );
        ...
        pnlDateTime.setBackground(new java.awt.Color(255, 255, 255));
        ...
        lblDate.setForeground(new java.awt.Color(0, 51, 255));
        ...
        pnlHomeSubSelection.setBackground(new java.awt.Color(0, 51, 255));
        ...
        lblHomeEmployeeAttendanceAbsent.setBackground(new java.awt.Color(102, 153, 255));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, cardHomeLayout.createSequentialGroup()
                ...
                .addGroup(cardHomeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(cardHomeLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jPanel28, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(cardHomeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(cardHomeLayout.createSequentialGroup()
                            .addComponent(jPanel15, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
                            .addComponent(jPanel33, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel36Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel36Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel36Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblPOItemCodeValidation, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 389, Short.MAX_VALUE)
        ...
        jPanel40Layout.setVerticalGroup(
            ...
            .addGroup(jPanel40Layout.createSequentialGroup()
                ...
                .addGap(19, 19, 19)
                .addComponent(jScrollPane20, javax.swing.GroupLayout.DEFAULT_SIZE, 345, Short.MAX_VALUE)
                .addGroup(jPanel40Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel40Layout.createSequentialGroup()
                        .addGap(20, 20, 20)
                        .addGroup(jPanel40Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel42Layout.setVerticalGroup(
            ...
            .addGroup(jPanel42Layout.createSequentialGroup()
                ...
                .addGap(19, 19, 19)
                .addComponent(jScrollPane21, javax.swing.GroupLayout.DEFAULT_SIZE, 345, Short.MAX_VALUE)
                .addGap(18, 18, 18)
        ...
        tblStock.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                " SKU Id", "Item Code", "Item Name", "Purchase Price", "Assigned Emp", "Supplier", "Stock Count", "Low Stock"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false, false, false
        ...
        jPanel20Layout.setVerticalGroup(
            ...
            .addGroup(jPanel20Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jScrollPane19, javax.swing.GroupLayout.DEFAULT_SIZE, 346, Short.MAX_VALUE)
                .addGap(20, 20, 20)
        ...
        jPanel37Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel37Layout.createSequentialGroup()
                ...
                .addGroup(jPanel37Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(lblPOItemCodeValidation1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 389, Short.MAX_VALUE)
            ...
            .addGroup(jPanel26Layout.createSequentialGroup()
                ...
                .addGroup(jPanel26Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel26Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(cmbSortTodaySales, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(20, 20, 20)
                .addComponent(jScrollPane27, javax.swing.GroupLayout.DEFAULT_SIZE, 345, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addGroup(jPanel26Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel26Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
            ...
            .addGroup(jPanel19Layout.createSequentialGroup()
                ...
                .addGroup(jPanel19Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel19Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(cmbSortSalesHistory, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(20, 20, 20)
                .addComponent(jScrollPane26, javax.swing.GroupLayout.DEFAULT_SIZE, 345, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addGroup(jPanel19Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        tblEmployee.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                " Id", "Name", "Position", "NIC", "Assigned Item"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        cmbEAItemName.setBackground(new java.awt.Color(0, 0, 0));
        cmbEAItemName.setForeground(new java.awt.Color(255, 255, 255));
        cmbEAItemName.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Item" }));
        cmbEAItemName.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cmbEAItemNameMouseClicked(evt);
            }
        });
        cmbEAItemName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbEAItemNameActionPerformed(evt);
            }
        });
        cmbEAItemName.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmbEAItemNameKeyPressed(evt);
            }
        });

        jLabel187.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel187.setForeground(new java.awt.Color(255, 255, 255));
        jLabel187.setText("Assign Item");
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel11Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jLabel187, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(44, 44, 44)
                        .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cmbEAItemName, 0, 307, Short.MAX_VALUE)
                            .addComponent(txtSelectedEmployeeNIC)
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(cmbEAItemName, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel14Layout.setVerticalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addGap(19, 19, 19)
                .addComponent(jScrollPane15, javax.swing.GroupLayout.DEFAULT_SIZE, 345, Short.MAX_VALUE)
                .addGap(20, 20, 20)
        ...
        jPanel21Layout.setVerticalGroup(
            ...
            .addGroup(jPanel21Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jScrollPane16, javax.swing.GroupLayout.DEFAULT_SIZE, 346, Short.MAX_VALUE)
                .addGap(20, 20, 20)
                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel23Layout.setVerticalGroup(
            ...
            .addGroup(jPanel23Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jScrollPane17, javax.swing.GroupLayout.DEFAULT_SIZE, 346, Short.MAX_VALUE)
                .addGap(20, 20, 20)
        ...
        jPanel32Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel32Layout.createSequentialGroup()
                ...
                .addGap(30, 30, 30)
                .addGroup(jPanel32Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblSelectedSupplierCompanyValidation, javax.swing.GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE)
                    .addComponent(lblSelectedSupplierUsernameValidation, javax.swing.GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE)
                    .addComponent(lblSelectedSupplierIdValidation, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE)
                    .addComponent(lblSelectedSupplierAddressValidation, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE)
                    ...
                    .addComponent(lblSelectedSupplierEmailValidation, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        cmbItemCategory.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Laptops", "Desktops", "Displays", "Phones", "Tablets", "Printers", "Cash Machines", "Other" }));
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/frames/img/MTNINV_logo.png"))); // NOI18N

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel13.setText("Stanbic Bank Inventory");
        ...
        version.setText("© Stanbic Inv.  | Stanbic Bank Inventory | Version 10.07");
        ...
        jLabel15.setText("Stanbic Inv. is an Inventory Management software for Stanbic Bank");
        ...
        jLabel18.setText("Increase the sales and keep track of every unit with this powerful stock management, order fulfillment, ");
        ...
        pnlParentLayout.setHorizontalGroup(
            ...
            .addGroup(pnlParentLayout.createSequentialGroup()
                ...
                .addGroup(pnlParentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pnlHeader, javax.swing.GroupLayout.DEFAULT_SIZE, 940, Short.MAX_VALUE)
        ...
        if (option == 0) {
            ...
            if ("".equals(txtBackupLocation.getText())) {
                ...
                try {
                    ...
                    p = runtime.exec("C:/Program Files/MySQL/MySQL Server 5.7/bin/mysqldump.exe --host=localhost --user=root --password=1234 MTN Inv._inventory -r " + path);
    ...
    private void tblEmployeeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEmployeeMouseClicked
        ...
        cmbEAItemName.setSelectedItem((String) tblEmployee.getValueAt(tblEmployee.getSelectedRow(), 4));
//        txtSelectedEmployeeSalary.setText((String) tblEmployee.getValueAt(tblEmployee.getSelectedRow(), 5));
        ...
        cmbEAItemName.setBorder(new FlatBorder());
    ...
    private void tblGRN1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblGRN1MouseClicked
        ...
        try {
            ...
            ResultSet rs2 = DB.DB.getData("SELECT assign_to FROM stock WHERE item_name = '" + selectedGRNItemName + "' ");
...
//                    txtGRNItemSellingPrice.grabFocus();
    ...
    private void cmbEAItemNameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbEAItemNameKeyPressed
        // TODO add your handling code here:
        try {
            //String selectedSupplier = cmbPOItemSupplier1.getSelectedItem().toString();

            cmbEAItemName.removeAllItems();

            ResultSet rs = DB.DB.getData("SELECT item_name FROM item WHERE item_status = 'Available'");

            while (rs.next()) {
                cmbEAItemName.addItem(rs.getString(1));
            }
            DB.DB.con.close();
        } catch (Exception e) {
        }
    }//GEN-LAST:event_cmbEAItemNameKeyPressed

    private void cmbEAItemNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbEAItemNameActionPerformed
        // TODO add your handling code here:
        try {
            //String selectedSupplier = cmbPOItemSupplier1.getSelectedItem().toString();
            ...
            ResultSet rs = DB.DB.getData("SELECT item_name FROM item");

            while (rs.next()) {
                cmbEAItemName.addItem(rs.getString("item_name"));
            }
            DB.DB.con.close();
        } catch (Exception e) {
        }
    }//GEN-LAST:event_cmbEAItemNameActionPerformed

    private void cmbEAItemNameMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmbEAItemNameMouseClicked
        // TODO add your handling code here:
         try {
            //String selectedSupplier = cmbPOItemSupplier1.getSelectedItem().toString();
    ...
    }//GEN-LAST:event_cmbEAItemNameMouseClicked
    ...
    private void setIcon() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("img/MTNINV_icon.png")));
    }
    ...
    private javax.swing.JComboBox<String> cmbEAItemName;
