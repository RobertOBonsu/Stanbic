...
public class Login extends javax.swing.JFrame {
    ...
    public void setPnlColor(JPanel pnl) {
        pnl.setBackground(new Color(204, 204, 35));
    }
   ...
   /* private void employeeLogin() {
    ...
    private void initComponents() {
        ...
        setTitle("MTN Inventory | Sign In");
        setUndecorated(true);
        setOpacity(0.985F);
        setResizable(false);
        ...
        loginWish.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        loginWish.setForeground(new java.awt.Color(51, 0, 51));
        ...
        jLabel3.setText("Log in to Stanbic Bank Inventory");

        accountType.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        accountType.setForeground(new java.awt.Color(51, 0, 51));
        accountType.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        accountType.setText("Administrator");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel2.setText("DEVELOPED BY ROBERT OSEI BONSU");
        ...
        adminLayout.setHorizontalGroup(
            ...
            .addGroup(adminLayout.createSequentialGroup()
                .addComponent(adminSelection, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        adminLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, adminLayout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(adminSelection, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
        );

        pnlLogin.add(admin, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 0, -1, -1));
        ...
        emergencySelection.setText("Super User");
        ...
        pnlAdmin.setBackground(new java.awt.Color(0, 0, 102));
        ...
        txtAdminUsername.setBackground(new java.awt.Color(0, 0, 102));
        ...
        txtAdminUsername.setToolTipText("Username");
        ...
        pwdAdminPassword.setBackground(new java.awt.Color(0, 0, 102));
        ...
        pwdAdminPassword.setToolTipText("password");
        ...
        pnlAdminLogin.setBackground(new java.awt.Color(0, 51, 204));

        btnAdminLogin.setBackground(new java.awt.Color(0, 0, 204));
        btnAdminLogin.setFont(new java.awt.Font("Arial Black", 1, 24)); // NOI18N
        ...
        pnlEmergency.setBackground(new java.awt.Color(255, 255, 255));

        cardEmergency.setBackground(new java.awt.Color(0, 102, 153));
        ...
        pnlSystemLogin.setBackground(new java.awt.Color(0, 102, 255));

        btnSystemLogin.setBackground(new java.awt.Color(0, 102, 255));
        btnSystemLogin.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        btnSystemLogin.setForeground(new java.awt.Color(255, 255, 255));
        btnSystemLogin.setText("Login");
        ...
        pnlParent.setBackground(new java.awt.Color(0, 51, 255));
